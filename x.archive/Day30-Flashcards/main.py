...
def next_card():
    ...
    if current_index == 0:  # Check if it's the first call to next_card
        ...
        canvas.itemconfig(card_footer, text="Konichiwa!", fill="black")
...
def flip_card():
    ...
    canvas.itemconfig(
        card_title, text="English", fill="white", font=("Ariel", 40, "bold", "italic")
    )
    canvas.itemconfig(
        card_word,
...
card_footer = canvas.create_text(400, 375, text="", font=("Ariel", 40, "italic"))
